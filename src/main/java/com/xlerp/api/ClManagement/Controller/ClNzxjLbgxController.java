...
import com.xlerp.api.ClManagement.Service.ClNzxjLbgxService;
...
public class ClNzxjLbgxController extends Controller {
    private final ClNzxjLbgxService clNzxjLbgxService = new ClNzxjLbgxService();
    private final PlshengchangongdanService plshengchangongdanService = new PlshengchangongdanService();

    @ActionKey("/clnzxjlbgx/getpage")
    @HttpMethod("GET")
    public void getpage() {
        ...
        try {
            ...
            Page page = clNzxjLbgxService.paginate(
                    pageNum, pageSz, matRecheckNo, orderno, size, singleWireStrength, mafactory,
                    leavefactoryDate, detectionTime, certificate, contractNo, woNo, ipoNo, writer,
                    writeTime, flag, status, memo, type
            );
    ...
    public void get() {
        ...
        try {
            ClNzxjLbgx clNzxjLbgx = clNzxjLbgxService.findById(Integer.parseInt(id));
            if (clNzxjLbgx != null) {
                renderJson(Result.success("查询成功").putData("clNzxjLbgx", clNzxjLbgx));
            } else {
    ...
    @ActionKey("/clnzxjlbgx/save")
    @HttpMethod("POST")
    public void save(ClNzxjLbgx clNzxjLbgx) {
        try {
            fillIpoNoAndContractNo(clNzxjLbgx);
            boolean success = clNzxjLbgxService.save(clNzxjLbgx);
            if (success) {
                renderJson(Result.success("保存成功").putData("clNzxjLbgxId", clNzxjLbgx.getId()));
            } else {
    ...
    @ActionKey("/clnzxjlbgx/update")
    @HttpMethod("PUT")
    public void update(ClNzxjLbgx clNzxjLbgx) {
        try {
            fillIpoNoAndContractNo(clNzxjLbgx);
            boolean success = clNzxjLbgxService.update(clNzxjLbgx);
            if (success) {
    ...
    public void delete() {
        ...
        try {
            boolean success = clNzxjLbgxService.deleteById(Integer.parseInt(id.trim()));
            if (success) {
     ...
     */
    @ActionKey("/clnzxjlbgx/getGongdanByWoNo")
    @HttpMethod("GET")
    ...
    private void fillIpoNoAndContractNo(ClNzxjLbgx clNzxjLbgx) {
        String woNo = clNzxjLbgx.getWoNo();
        if (woNo != null && !woNo.trim().isEmpty()) {
            Plshengchangongdan gd = plshengchangongdanService.findByWoNo(woNo.trim());
            if (gd != null) {
                clNzxjLbgx.setIpoNo(gd.getIpoNo());
                clNzxjLbgx.setContractNo(gd.getContractNo());
            }
        }
    }
}