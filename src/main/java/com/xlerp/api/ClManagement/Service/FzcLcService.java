...
public class FzcLcService {
    private static final ClFzcLc dao = new ClFzcLc();
    private static final String UPLOAD_DIR = "uploads/";

    public Page<ClFzcLc> paginate(int pageNumber, int pageSize, String mafactory, String matMaterial, String orderno, String matRecheckNo, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        String select = "select *";
        StringBuilder from = new StringBuilder("from cl_fzc_lc where isdelete = 0");
    ...
    public ClFzcLc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClFzcLc fzcLc) {
        return fzcLc.save();
    }

    public boolean update(ClFzcLc fzcLc) {
        return fzcLc.update();
    }
