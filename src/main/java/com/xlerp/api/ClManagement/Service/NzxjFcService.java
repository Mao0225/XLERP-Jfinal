...
public class NzxjFcService {

    private static final ClNzxjFc dao = new ClNzxjFc();
    private static final String UPLOAD_DIR = "uploads/";

    public Page<ClNzxjFc> paginate(int pageNumber, int pageSize, String mafactory, String maQuality, String orderno, String matRecheckNo, String sampleNumber, String testResult, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        String select = "select *";
        StringBuilder from = new StringBuilder("from cl_nzxj_fc where isdelete = 0");
        ...
        if (StrKit.notBlank(testResult)) {
            from.append(" and testResult like ?");
        }
    ...
    public ClNzxjFc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClNzxjFc nzxjFc) {
        return nzxjFc.save();
    }

    public boolean update(ClNzxjFc nzxjFc) {
        return nzxjFc.update();
    }
