...
public class JxjjLbgxService {

    private static final ClJxjjLbgx dao = new ClJxjjLbgx();
    private static final String UPLOAD_DIR = "uploads/";

    public Page<ClJxjjLbgx> paginate(int pageNumber, int pageSize, String mafactory, String orderno, String matRecheckNo, String size, String singleWireStrength, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        String select = "select *";
        StringBuilder from = new StringBuilder("from cl_jxjj_lbgx where isdelete = 0");
        ...
        if (StrKit.notBlank(singleWireStrength)) {
            from.append(" and singleWireStrength like ?");
        }
    ...
    public ClJxjjLbgx findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClJxjjLbgx jxjjLbgx) {
        return jxjjLbgx.save();
    }

    public boolean update(ClJxjjLbgx jxjjLbgx) {
        return jxjjLbgx.update();
    }
