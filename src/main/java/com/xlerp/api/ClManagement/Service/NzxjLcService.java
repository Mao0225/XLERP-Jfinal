...
public class NzxjLcService {
    private static final ClNzxjLc dao = new ClNzxjLc();
    private static final String UPLOAD_DIR = "uploads/";

    public Page<ClNzxjLc> paginate(int pageNumber, int pageSize, String mafactory, String maQuality, String matMaterial, String orderno, String matRecheckNo, String sampleNumber, String tensileStrength, String elongation, String hardness, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        String select = "select *";
        StringBuilder from = new StringBuilder("from cl_nzxj_lc where isdelete = 0");
        ...
        if (StrKit.notBlank(sampleNumber)) {
            from.append(" and sampleNumber like ?");
        }
    ...
    public ClNzxjLc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClNzxjLc nzxjLc) {
        return nzxjLc.save();
    }

    public boolean update(ClNzxjLc nzxjLc) {
        return nzxjLc.update();
    }
