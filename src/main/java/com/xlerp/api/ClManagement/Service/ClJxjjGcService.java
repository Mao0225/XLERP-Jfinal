...
/**
 * Service for ClJxjjGc 接续金具钢材数据采集表
 */
public class ClJxjjGcService {
    private static final ClJxjjGc dao = new ClJxjjGc();

    public Page<ClJxjjGc> paginate(
            int pageNumber,
            int pageSize,
            String mafactory,
            String batch,
        ...
        StringBuilder from = new StringBuilder("from cl_jxjj_gc where isdelete = 0");
    ...
    public ClJxjjGc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClJxjjGc clJxjjGc) {
        return clJxjjGc.save();
    }

    public boolean update(ClJxjjGc clJxjjGc) {
        return clJxjjGc.update();
    }
