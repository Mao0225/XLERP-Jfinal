...
public class BgxjsbxjFcService {

    private static final ClBgxjsbxjFc dao = new ClBgxjsbxjFc();
    ...
    public Page<ClBgxjsbxjFc> paginate(int pageNumber, int pageSize, String maQuality, String mafactory, String orderno, String matRecheckNo, String testType, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        ...
        if (StrKit.notBlank(testType)){
            from.append(" and testType like ?");
        }
    ...
    public ClBgxjsbxjFc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClBgxjsbxjFc bgxjsbxjFc) {
        return bgxjsbxjFc.save();
    }

    public boolean update(ClBgxjsbxjFc bgxjsbxjFc) {
        return bgxjsbxjFc.update();
    }
