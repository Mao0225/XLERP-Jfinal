...
public class JyhLcService {
    private static final ClJyhLc dao = new ClJyhLc();
    private static final String UPLOAD_DIR = "uploads/";

    public Page<ClJyhLc> paginate(int pageNumber, int pageSize, String mafactory, String matMaterial, String orderno, String matRecheckNo, String surfaceQuality, String size, String leavefactoryDate, String detectionTime, String certificate, String contractNo, String woNo, String ipoNo, String writer, String writeTime) {
        String select = "select *";
        StringBuilder from = new StringBuilder("from cl_jyh_lc where isdelete = 0");
        ...
        if (StrKit.notBlank(surfaceQuality)) {
            from.append(" and surfaceQuality like ?");
        }
    ...
    public ClJyhLc findById(int id) {
        return dao.findById(id);
    }

    public boolean save(ClJyhLc jyhLc) {
        return jyhLc.save();
    }

    public boolean update(ClJyhLc jyhLc) {
        return jyhLc.update();
    }
