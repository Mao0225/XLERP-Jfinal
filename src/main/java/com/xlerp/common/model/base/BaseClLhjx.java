...
public abstract class BaseClLhjx<M extends BaseClLhjx<M>> extends Model<M> implements IBean {
	 ...
	 * 抗拉强度实测值1
	 */
	public void setTensileStrength1(java.math.BigDecimal tensileStrength1) {
	 ...
	 * 抗拉强度实测值1
	 */
	public java.math.BigDecimal getTensileStrength1() {
		return get("tensileStrength1");
	}
	
	/**
	 * 抗拉强度实测值2
	 */
	public void setTensileStrength2(java.math.BigDecimal tensileStrength2) {
	 ...
	 * 抗拉强度实测值2
	 */
	public java.math.BigDecimal getTensileStrength2() {
		return get("tensileStrength2");
	}
	
	/**
	 * 抗拉强度实测值3
	 */
	public void setTensileStrength3(java.math.BigDecimal tensileStrength3) {
	 ...
	 * 抗拉强度实测值3
	 */
	public java.math.BigDecimal getTensileStrength3() {
		return get("tensileStrength3");
	}
	
	/**
	 * 抗拉强度要求值
	 */
	public void setTensileStrengthRequired(java.math.BigDecimal tensileStrengthRequired) {
	 ...
	 * 抗拉强度要求值
	 */
	public java.math.BigDecimal getTensileStrengthRequired() {
		return get("tensileStrengthRequired");
	}
